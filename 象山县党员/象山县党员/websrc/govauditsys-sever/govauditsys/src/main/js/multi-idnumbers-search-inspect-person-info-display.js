...
class MultiIdNumbersSearchInspectPersonInfoDisplay extends React.Component {
	...
	loadFromServer(idNumbers, pageSize) {
		client({
			method: 'POST',
			path: '/inspectpersoninfo/multiidnumbersearch',
...
module.exports = MultiIdNumbersSearchInspectPersonInfoDisplay;
