...
class MultiIdNumbersSearchCommunistInfoDisplay extends React.Component {
	...
	loadFromServer(idNumbers, pageSize) {
		client({
			method: 'POST',
			path: '/communistinfo/multidnumbersearch',
...
module.exports = MultiIdNumbersSearchCommunistInfoDisplay;
